                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Image(image: AssetImage("asset/book5.jpg"),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text('You',style: TextStyle( fontSize: 25),),
                                          ),Padding(
                                            padding: EdgeInsets.only(right: width*0.05),
                                            child:  Text('Caroline Kepnes',style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 15),),
                                          ),
                                        ],
                                      ),
                                    ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            padding: EdgeInsets.only(left: width*0.02),
                                            child:  Text('You is a thriller novel by Caroline Kepnes, published in September 2014.\nThe novel has been translated into 19 languages, and was adapted \n into a television series of the same name.',style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 11),),
                                          ),
                                        ],
                                      ),
                                    ),

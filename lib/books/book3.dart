                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text('Scion Of IkshVaku',style: TextStyle( fontSize: 25),),
                                          ),Padding(
                                            padding: EdgeInsets.only(right: width*0.05),
                                            child:  Text('Amish',style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 15),),
                                          ),
                                        ],
                                      ),
                                    ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            padding: EdgeInsets.only(left: width*0.02),
                                            child:  Expanded(
                                                child: Text('Scion of Ikshvaku (also known as\nRam: Scion of Ikshvaku) is a one to one replica of the \nevents taking place before the epic tale "Ramayana" and \nalso the fourth book of Amish Tripathi, fourth book of \nAmishverse and first book of Ram Chandra Series.',overflow: TextOverflow.clip, style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 15),)),
                                          ),
                                        ],
                                      ),
                                    ),

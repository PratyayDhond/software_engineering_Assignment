                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text('Wonder',style: TextStyle( fontSize: 25),),
                                          ),Padding(
                                            padding: EdgeInsets.only(right: width*0.05),
                                            child:  Text('R.J.Palacio',style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 15),),
                                          ),
                                        ],
                                      ),
                                    ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            padding: EdgeInsets.only(left: width*0.02),
                                            child:  Expanded(
                                                child: Text('\nOne of our favorite children’s books is this one by\nTheresa LaBrecque.  Each illustration comes to life in\n the poetry of the artist. In the collection of paintings,\n you can find 38 pages of charming poems describing\nfanciful tea parties, including one delivered by a whale!',overflow: TextOverflow.clip, style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 15),)),
                                          ),
                                        ],
                                      ),
                                    ),

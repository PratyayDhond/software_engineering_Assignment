                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            padding: EdgeInsets.only(left: width*0.02),
                                            child:  Expanded(
                                                child: Text('\nOne Indian Girl is an Indian Book written by the Indian\nauthor Chetan Bhagat.The book is about a girl named \nRadhika Mehta, who is a worker at the Distressed Debt \ngroup of Goldman Sachs, the investment bank.',overflow: TextOverflow.clip, style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 15),)),
                                          ),
                                        ],
                                      ),
                                    ),

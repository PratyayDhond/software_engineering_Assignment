                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Image(image: AssetImage("asset/book6.jpg"),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text('The Da Vince Code',style: TextStyle( fontSize: 25),),
                                          ),Padding(
                                            padding: EdgeInsets.only(right: width*0.05),
                                            child:  Text('Dan Brown',style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 15),),
                                          ),
                                        ],
                                      ),
                                    ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            padding: EdgeInsets.only(left: width*0.02),
                                            child:  Text('The Da Vinci Code is a 2003 mystery thriller novel by Dan Brown. \nIt is Browns second novel to include the character Robert Langdon: \n the first was his 2000 novel Angels & Demons. ',style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 11),),
                                          ),
                                        ],
                                      ),
                                    ),

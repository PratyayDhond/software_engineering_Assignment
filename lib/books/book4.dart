                                    ...
                                    Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: EdgeInsets.only(),
                                            child: Text('Things no one \nelse can teach us',style: TextStyle( fontSize: 25),),
                                          ),Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            padding: EdgeInsets.only(left: width*0.02),
                                            child:  Expanded(
                                                child: Text('HUMBLE THE POET, AKA KANWER SINGH, is a Canadian\n-born rapper, spokenword artist, poet, bestselling\nauthor, and former elementary school teacher with a wildly \npopular blog of over 100, 000 monthly readers. He has over\n930, 000 social media followers and his first book, Unlearn, \nis a Globe & Mail bestseller in Canada. He has performed at\nconcerts and festivals including Lollapalooza and been\n featured in major media including Buzzfeed and Huffington \nPost. This text refers to an alternate kindle_edition edition.',overflow: TextOverflow.clip, style: TextStyle(color: Color(0xff9A9A9A,), fontSize: 14),)),
                                          ),
                                        ],
                                      ),
                                    ),
